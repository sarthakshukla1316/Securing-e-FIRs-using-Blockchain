        ...
        <div className="flex flex-col flex-grow">
          ...
          <div className="flex-grow p-6 overflow-auto bg-white">
            <div className="w-full">
              <div className="flex items-center justify-center w-full bgImg">
                  ...
                  <div className="w-full h-full px-6 text-gray-800">
                    <div className="flex flex-row justify-center w-full h-full mb-12 overflow-y-auto md:mb-0">
                      <div
                        ...
                        <h2 className="mb-3 text-4xl font-bold">Complaint Status</h2>
                        ...
                        <div className="flex flex-wrap mb-5">
                          <div className="w-full mb-6 md:mb-0">
                            ...
                            <p className="px-3 py-3 bg-gray-200">
                              {complaint?.complaintDescription}
                            </p>
                          </div>
                        </div>
                        {complaint.isValid === null ? (
                          <div className="flex flex-wrap mb-2">
                            "Complaint has not been reviewed yet"
                          </div>
                        ) : (
                          <>
                            <div className="flex flex-wrap mb-5">
                            ...
                            {!complaint.isValid ? (
                              <div className="mb-2 ">
                                ...
                                <p className="text-red-500 text-md">{complaint.reason}</p>
                              </div>
                            ) : (
                              <>
                                <div className="mb-6 bg-gray-200">
                                  <div className="w-full px-3 mb-6 md:mb-0">
                                    <h4 className="w-full mb-3 font-bold">
                                      Complaint Type Marked as
                                    </h4>
                                  </div>
                                  <div className="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                                    {complaint.isCognizible ? 'Cognizible' : 'Non-Cognizible'}
                                  </div>
                                </div>
                                {complaint.isCognizible === null ? (
                                  'Complaint type has not been reviewed yet'
                                  ...
                                  <>
                                    <div className="mb-2 bg-gray-200">
                                      <div className="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                                        <label
                                          className="mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase"
                                          htmlFor="grid-last-name">
                                          FIR Status
                                        </label>
                                        <p>
                                    ...
                                    {complaint.firFiled ? (
                                      <div className="px-3 mt-3 mb-2 bg-gray-200">
                                        <label
                                          className="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase"
                                          htmlFor="grid-last-name">
                                          Chargesheet
