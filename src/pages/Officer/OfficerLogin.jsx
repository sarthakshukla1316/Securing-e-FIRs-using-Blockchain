        ...
        <div class="px-6 h-full text-gray-800">
          <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            ...
            <div class="xl:ml-10 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
              <form action="">
                <h2 className="text-4xl font-bold mb-3">Personel Login</h2>
                ...
                <div class="flex flex-wrap mb-6">
                  <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                      class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight uppercase focus:outline-none focus:bg-white"
                      id="officerIDInput"
                      type="text"
