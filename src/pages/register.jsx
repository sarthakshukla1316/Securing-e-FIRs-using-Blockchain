                    ...
                    <div class="xl:ml-10 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                        {
                            !showOtp ? (
                                <form>
                                    ...
                                    <div class="mb-6">
                                        <input
                                        type="text" onChange={(e) => setAadharNumber(e.target.value)}
                                        class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        id="exampleFormControlInput2"
                                    ...
                                    <div class="mb-6">
                                        <input
                                        type="password" onChange={(e) => setPin(e.target.value)}
                                        class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        id="exampleFormControlInput2"
                                    ...
                                    <a className='text-[#0000ff]' href="">Privacy Policy</a> and <a className='text-[#0000ff]' href="">Terms of Service</a> apply</p>
                                </form>
                            ) : (
                                <form>
                                    ...
                                    <OtpInput
                                        ...
                                        inputStyle={{ border: '1px solid #999', margin: 10, marginBottom: 14, width: '40px', height: '40px' }}
                                    />
