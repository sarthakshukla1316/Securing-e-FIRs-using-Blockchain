...
const FileComplaint = () => {
  ...
  const { createComplaint, createComplaintLoading, isSuccess } = usePostComplaint();
  ...
  const complaintSubmitHandler = () => {
    ...
    const { city, pincode, policeStation, complaintDescription } = complaintDocument;
    if (!city || !pincode || !policeStation || complaintDescription) {
      ...
      <div className="flex w-screen h-screen text-gray-700">
        ...
        <div className="flex flex-col flex-grow">
          ...
          <div className="flex-grow p-6 overflow-auto bg-white">
            <div className="flex items-center justify-center w-full h-full bgImg">
                ...
                <div class="px-6 h-full text-gray-800  w-full">
                  <div class=" flex flex-row justify-center mb-12 md:mb-0 overflow-y-auto w-full h-full mt-6">
                    <form enctype="multipart/form-data">
                      <h2 className="mb-0.5 text-4xl font-bold">File Complaint</h2>
                      <p class="text-sm text-[#aca9a9] font-light mb-3 pt-1">
                      ...
                      <div className="mt-16">
                          ...
                          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <div class="relative">
                              <select
                                ...
                                name="policeStation"
                                onChange={handleForm}>
                                <option value={null}>Select a police station</option>
                        ...
                        <div class="flex flex-wrap mb-2 px-3 mt-8">
                          <label
                            class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                          ...
                          <button
                            type="button"
                            class="w-full mt-8  inline-block px-7 py-3 bg-[#174793] text-white font-medium text-lg leading-snug uppercase rounded shadow-md hover:bg-[#16325d] hover:shadow-lg focus:bg-[#174793] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#174793] active:shadow-lg transition duration-150 ease-in-out "
