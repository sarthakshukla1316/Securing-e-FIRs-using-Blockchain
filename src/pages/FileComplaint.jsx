...
import useCustomerComplaints from "../api/customer/useCustomerComplaint";
...
const FileComplaint = () => {
  ...
  const { createComplaint, createComplaintLoading } = useCustomerComplaints();
  ...
  const complaintSubmitHandler = () => {
    ...
    createComplaint(complaintFormData);
  };
            ...
            <form enctype="multipart/form-data">
              ...
              <div class="flex flex-wrap mb-2 px-3">
                ...
                <input
                  ...
                  type="file"
                  onChange={(event) =>
                    setComplaintDocument(event.target.files[0])
                  }
